...
var item=_a3a.children("div.combobox.json-item-hover");
if(!item.length){
item=_a3a.children("div.combobox.json-item-selected");
}
item.removeClass("combobox.json-item-hover");
var _a3b="div.combobox.json-item:visible:not(.combobox.json-item-disabled):first";
var _a3c="div.combobox.json-item:visible:not(.combobox.json-item-disabled):last";
if(!item.length){
...
if(item.length){
item.addClass("combobox.json-item-hover");
...
if(el.hasClass("combobox.json-item-selected")){
el.removeClass("combobox.json-item-selected");
...
var el=opts.finder.getEl(_a48,v);
if(!el.hasClass("combobox.json-item-selected")){
el.addClass("combobox.json-item-selected");
...
_a59.find(".combobox.json-item-hover").removeClass("combobox.json-item-hover");
_a59.find(".combobox.json-item,.combobox.json-group").hide();
var data=_a57.data;
var vv=[];
$.map(qq,function(q){
q=$.trim(q);
...
var item=_a5e.children("div.combobox.json-item-hover");
if(item.length){
var row=opts.finder.getRow(_a5d,item);
var _a5f=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox.json-item-selected")){
...
$(_a61).addClass("combobox.json-f");
$(_a61).combo($.extend({},opts,{onShowPanel:function(){
$(this).combo("panel").find("div.combobox.json-item:hidden,div.combobox.json-group:hidden").show();
...
function _a64(e){
$(this).children("div.combobox.json-item-hover").removeClass("combobox-item-hover");
var item=$(e.target).closest("div.combobox.json-item");
if(!item.hasClass("combobox.json-item-disabled")){
item.addClass("combobox.json-item-hover");
}
e.stopPropagation();
};
function _a65(e){
$(e.target).closest("div.combobox.json-item").removeClass("combobox-item-hover");
e.stopPropagation();
};
function _a66(e){
...
var item=$(e.target).closest("div.combobox.json-item");
if(!item.length||item.hasClass("combobox.json-item-disabled")){
return;
}
...
var _a6b=$(this).children(".combobox.json-stick");
if(!_a6b.length){
_a6b=$("<div class=\"combobox.json-stick\"></div>").appendTo(this);
}
_a6b.hide();
var _a6c=$(_a6a).data("combobox");
$(this).children(".combobox.json-group:visible").each(function(){
var g=$(this);
...
$(this).addClass("combobox.json-f").attr("comboboxName",$(this).attr("textboxName"));
});
},getData:function(jq){
...
dd.push("<div id=\""+(_a82.groupIdPrefix+"_"+(_a82.groups.length-1))+"\" class=\"combobox.json-group\">");
...
var cls="combobox.json-item"+(row.disabled?" combobox.json-item-disabled":"")+(g?" combobox.json-gitem":"");
dd.push("<div id=\""+(_a82.itemIdPrefix+"_"+i)+"\" class=\""+cls+"\">");
if(opts.showItemIcon&&row.iconCls){
dd.push("<span class=\"combobox.json-icon "+row.iconCls+"\"></span>");
}
